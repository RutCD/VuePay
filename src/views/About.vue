<template>
  <div class="about">
    ...
    <button id="yout-button">Paypal</button>
    <div v-if="!paidfor">
...
export default {
  data:() => {
    return {
      ...
      paidfor:false,
      products:[
        {'id':'01','name':"Estufa","price":"15400.00","thumbnail":"https://picsum.photos/400"},
  ...
  methods:{
    callApi(){
      let paypal;
      try{
        paypal = loadScript({"client-id":"AdFpLpXtr02H9mYSH8IVV2jPxGy0Hlr4QjU2EvUwBC2yFtIlLcQqRE7nUoQESOIfOQtcVRUhbJ6AwS9k",});
      } catch(error){
